...
class VCSideMenu2: UIViewController, UITableViewDataSource, UITableViewDelegate
{
...
//        transferButton.layer.cornerRadius = 17.5
        ...
        self.sideView.layer.cornerRadius = 20.0
...
//        arrayMenuOptions.append(["title":"Basket", "icon":"basket", "vc":"BasketViewController"])
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        cell.backgroundColor = UIColor(hexString: "#31156C")
